...
export default function Navbar() {
  return (
    <nav style={{
      ...
      background: "linear-gradient(180deg,rgba(3,6,9,.96) 0%,transparent 100%)",
      ...
      <div style={{ fontFamily: "var(--font-mono)", fontSize: ".7rem", color: "var(--text-dim)", display: "flex", alignItems: "center", gap: 8 }}>
